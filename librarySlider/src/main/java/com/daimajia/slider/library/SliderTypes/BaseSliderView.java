...
//    private Picasso mPicasso;
    ...
    protected void bindEventAndShow(final View v, ImageView targetImageView){
        ...
        if(mUrl!=null){
            ...
            ImageLoader.getInstance().displayImage(Uri.fromFile(mFile).toString(),targetImageView,imageLoadingListener);
        }else if(mRes != 0){
            ImageLoader.getInstance().displayImage("drawable://"+mRes,targetImageView,imageLoadingListener);
        }else{
            return;
        }
