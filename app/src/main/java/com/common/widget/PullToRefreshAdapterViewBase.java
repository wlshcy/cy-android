...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView>
	...
	private OnRefreshingScrollToOriginal mOnRefreshingScrollToOriginal;
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		...
		if (l == 0 && t == 0 && getState() == State.REFRESHING
				&& mOnRefreshingScrollToOriginal != null) {
			mOnRefreshingScrollToOriginal.onScrollToOriginal();
		}
	}
	...
	public OnRefreshingScrollToOriginal getOnRefreshingScrollToOriginal() {
		return mOnRefreshingScrollToOriginal;
	}

	public void setOnRefreshingScrollToOriginal(
			OnRefreshingScrollToOriginal mOnRefreshingScrollToOriginal) {
