...
import com.lynp.ui.fragment.ItemDetailFragment;
import com.lynp.ui.fragment.TransparentFragment;
...
public class ItemDetailAdapter extends FragmentPagerAdapter {
    ...
    Context mContext;
    public ItemDetailAdapter(FragmentManager fm, Bundle bundle) {
        super(fm);
        this.bundle = bundle;
    }
